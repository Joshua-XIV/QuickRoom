...
const JoinRoomPopup = ({onClose, onJoin, code}) => {
  ...
  return (
    <div className='flex w-xl h-[50vh] bg-orange items-center justify-center rounded-3xl'>
      <form onSubmit={handleJoin}  autoComplete="off" className='bg-white border-2 border-amber-500 rounded-3xl flex flex-col space-y-4 w-full h-full p-4'>
